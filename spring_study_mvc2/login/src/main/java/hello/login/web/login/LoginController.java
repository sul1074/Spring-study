...
//    @PostMapping("/login")
    ...
    public String loginV4(@Valid @ModelAttribute("loginForm") LoginForm form,
                          @RequestParam(defaultValue = "/", value = "redirectURL") String redirectURL,
                          BindingResult bindingResult,
                          HttpServletRequest request) {
...
//    @PostMapping("/logout")
    ...
    private static void expireCookie(String cookieName, HttpServletResponse response) {
